package com.example.a12700.linkgameofme;
...
import com.example.a12700.linkgameofme.board.GameService;
import com.example.a12700.linkgameofme.board.impl.GameServiceImpl;
import com.example.a12700.linkgameofme.utils.GameConf;
import com.example.a12700.linkgameofme.utils.LinkInfo;
import com.example.a12700.linkgameofme.view.GameView;
import com.example.a12700.linkgameofme.view.Piece;

public class LinkActivity extends Activity implements com.example.a12700.linkgameofme.BaseHandlerCallBack {
    /**
     * 游戏配置对象
     */
     ...
     */
    private void init() {
        config = new GameConf(10, 11, 2, 10, GameConf.DEFAULT_TIME, this);
        // 得到游戏区域对象
